document.addEventListener('DOMContentLoaded', function() {
    ...
    let matches = loadData('singles-matches') || [];
    const players = loadData('singles-teams') || [];
    ...
    function renderMatchesToScore() {
        ...
        incompleteMatches.forEach(match => {
            const team1 = players.find(p => p.id === match.team1.id);
            const team2 = players.find(p => p.id === match.team2.id);
